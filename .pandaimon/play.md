...
…and leave `CLAUDE.md` as its stub.
...
- What you compiled (the files written), and from what — and **which surface is live for them right now** (e.g. "you're in Claude Code, so `CLAUDE.md` + `.claude/` are live; `AGENTS.md` stays a stub until you open this home in a runtime that reads it").
